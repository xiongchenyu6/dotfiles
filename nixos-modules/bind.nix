    ...
    services = {
      ...
      reload-private-zone = {
        ...
        script = ''
          ...
          \$TTL 3600
          \$ORIGIN inner.${config.networking.domain}.
          @         IN SOA    inner.${config.networking.domain}. hostmaster.inner.${config.networking.domain}. ( 1 3h 1h 1w 1d )
          @         IN NS     ns1.inner.${config.networking.domain}.
