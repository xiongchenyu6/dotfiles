" python3 plugins
call remote#host#RegisterPlugin('python3', '/Users/fruittec/.cache/vimfiles/repos/github.com/Shougo/denite.nvim/rplugin/python3/denite', [
      \ {'sync': v:true, 'name': '_denite_init', 'type': 'function', 'opts': {}},
      \ {'sync': v:true, 'name': '_denite_start', 'type': 'function', 'opts': {}},
     \ ])
call remote#host#RegisterPlugin('python3', '/Users/fruittec/.cache/vimfiles/repos/github.com/Shougo/deoplete.nvim/rplugin/python3/deoplete', [
...
" python plugins
call remote#host#RegisterPlugin('python', '/Users/fruittec/.cache/vimfiles/repos/github.com/floobits/floobits-neovim/rplugin/python/floobits', [
      ...
      \ {'sync': v:false, 'name': 'FlooRefreshWorkspace', 'type': 'command', 'opts': {}},
