...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (which-key web-mode use-package tide typescript-mode string-inflection spaceline psc-ide pip-requirements org-pomodoro org-download org-brain magit-gh-pulls live-py-mode js2-refactor hy-mode helm-make flycheck-haskell evil-org evil-nerd-commenter evil-matchit editorconfig dumb-jump dante company-web column-enforce-mode browse-at-remote ace-window ace-link eclim sbt-mode smartparens evil window-purpose helm helm-core avy markdown-mode flycheck ht projectile magit magit-popup org-plus-contrib f js2-mode s yapfify yaml-mode xterm-color xcscope ws-butler winum web-completion-data web-beautify wakatime-mode volatile-highlights vmd-mode vi-tilde-fringe uuidgen undo-tree toc-org tagedit symon sunshine sql-indent smeargle slim-mode shell-pop shakespeare-mode scss-mode sass-mode reveal-in-osx-finder restart-emacs rainbow-mode rainbow-identifiers rainbow-delimiters pyvenv pytest pyim pyenv-mode py-isort pug-mode psci powerline popwin plantuml-mode phpunit phpcbf php-extras php-auto-yasnippets persp-mode pdf-tools pcre2el pbcopy password-generator paradox pangu-spacing ox-twbs ox-reveal ox-gfm osx-trash osx-dictionary orgit org-projectile org-present org-bullets open-junk-file noflet neotree multiple-cursors multi-term mu4e-maildirs-extension mu4e-alert move-text molokai-theme mmm-mode meghanada markdown-toc magit-gitflow macrostep lorem-ipsum livid-mode linum-relative link-hint launchctl json-mode js-doc intero info+ indent-guide impatient-mode imenu-list hungry-delete hlint-refactor hl-todo hindent highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-themes helm-swoop helm-pydoc helm-purpose helm-projectile helm-mode-manager helm-hoogle helm-gtags helm-gitignore helm-flx helm-descbinds helm-dash helm-css-scss helm-company helm-c-yasnippet helm-ag haskell-snippets graphviz-dot-mode gradle-mode goto-chg google-translate golden-ratio gnuplot github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist gh-md ggtags fuzzy flyspell-correct-helm flycheck-pos-tip flx-ido find-by-pinyin-dired fill-column-indicator fasd fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-mc evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-exchange evil-ediff evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help erc-yt erc-view-log erc-terminal-notifier erc-social-graph erc-image erc-hl-nicks ensime emmet-mode elisp-slime-nav drupal-mode dracula-theme diminish diff-hl dash-at-point cython-mode csv-mode company-tern company-statistics company-quickhelp company-ghci company-ghc company-emacs-eclim company-cabal company-auctex company-anaconda color-identifiers-mode coffee-mode cmm-mode clean-aindent-mode bind-key auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile auctex-latexmk aggressive-indent adaptive-wrap ace-pinyin ace-jump-helm-line ac-ispell))))
(custom-set-faces
