...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages (quote (xkcd emoji-cheat-sheet-plus company-emoji
                                            company-quickhelp web-completion-data dash-functional
                                            auto-complete tern pdf-tools tablist fasd
                                            ranger stickyfunc-enhance srefactor eclim
                                            smartparens evil-escape yapfify xterm-color
                                            ws-butler winum which-key web-mode web-beautify
                                            wakatime-mode volatile-highlights vi-tilde-fringe
                                            uuidgen use-package unfill toc-org theme-changer
                                            tagedit symon sunshine string-inflection spaceline
                                            smeargle slim-mode shell-pop scss-mode sass-mode
                                            restart-emacs rase rainbow-delimiters pyvenv
                                            pytest pyenv-mode py-isort pug-mode popwin
                                            plantuml-mode pip-requirements persp-mode
                                            pcre2el paradox osx-location orgit org-projectile
                                            org-present org-pomodoro org-download org-bullets
                                            open-junk-file noflet neotree mwim multi-term
                                            mu4e-maildirs-extension mu4e-alert move-text
                                            mmm-mode meghanada markdown-toc magithub magit-gitflow
                                            magit-gh-pulls macrostep lorem-ipsum livid-mode
                                            live-py-mode linum-relative link-hint less-css-mode
                                            ledger-mode json-mode js2-refactor js-doc
                                            intero info+ indent-guide hy-mode hungry-delete
                                            htmlize hlint-refactor hl-todo hindent highlight-parentheses
                                            highlight-numbers highlight-indentation hide-comnt
                                            help-fns+ helm-themes helm-swoop helm-pydoc
                                            helm-purpose helm-projectile helm-mode-manager
                                            helm-make helm-hoogle helm-gitignore helm-flx
                                            ...
                                            flycheck-ledger flycheck-haskell flx-ido fill-column-indicator
                                            ...
                                            evil-iedit-state evil-exchange evil-ediff
                                            evil-args evil-anzu eval-sexp-fu eshell-z
                                            eshell-prompt-extras esh-help erc-yt erc-view-log
                                            erc-terminal-notifier erc-social-graph erc-image
                                            erc-hl-nicks ensime emmet-mode elisp-slime-nav
                                            dumb-jump diff-hl define-word dash-at-point
                                            cython-mode company-web company-tern company-statistics
                                            company-ghci company-ghc company-emacs-eclim
                                            company-cabal company-anaconda column-enforce-mode
                                            coffee-mode cmm-mode clean-aindent-mode browse-at-remote
                                            auto-yasnippet auto-highlight-symbol auto-dictionary
                                            auto-compile aggressive-indent adaptive-wrap
