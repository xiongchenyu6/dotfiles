...
;; (setq copilot-node-executable "/nix/store/cdalbhzm3z4gz07wyg89maprdbjc4yah-nodejs-14.17.0/bin/node")
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-mode
    ...
    ((c-mode c++-mode python-mode go-mode rust-mode sh-mode js-mode js2-mode typescript-mode nix-mode web-mode css-mode scss-mode less-css-mode json-mode yaml-mode dockerfile-mode markdown-mode) . lsp-deferred)
    )
  ...
  (add-hook 'nix-mode-hook #'(lambda () (add-hook 'before-save-hook #'nixfmt-buffer t t)))
