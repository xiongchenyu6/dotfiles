...
*** Transparent
#+begin_src emacs-lisp
(add-to-list 'default-frame-alist '(alpha 88 100))
#+end_src
** General
*** Native Setup
#+begin_src emacs-lisp
...
(add-hook 'vterm-mode-hook
          (lambda ()
            (add-hook 'meow-insert-mode-hook (lambda () (vterm-copy-mode -1)) nil 'make-it-local)
            (add-hook 'meow-normal-mode-hook (lambda () (vterm-copy-mode 1)) nil 'make-it-local)))
#+end_src
*** Better Search
#+begin_src emacs-lisp
...
(setq copilot-node-executable "/nix/store/pzsk91sxxin42axlvdfbbbjiyz3jzfy3-nodejs-16.17.1/bin/node")
