...
(setq recentf-max-saved-items 500)  ; Reduced from 9999
(setq recentf-max-menu-items 50)   ; Reduced from 999
...
(setq recentf-exclude
      '("COMMIT" "autoloads" "archive-contents" "eld" ".newsrc"
        ...
        "pyim-dcache-.*"))
;; Save recentf list less frequently - only on Emacs exit
...
(use-package aidermacs
  ...
  (aidermacs-default-model "xai/grok-3-mini-beta"))
#+end_src
** Lang
*** completion
#+begin_src emacs-lisp
...
*** Org Roam
#+begin_src emacs-lisp
(setq org-roam-directory (expand-file-name "~/Documents/github/xiongchenyu6/xiongchenyu6.github.io/content-org/Notes/")
...
#+begin_src emacs-lisp
  ...
  (define-key addon-map "a" 'gp-tdwim) 
