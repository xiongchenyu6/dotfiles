...
(setq initial-scratch-message "xxxxx")
...
;; (setq prettify-symbols-alist `(("def" . "ƒ") ("composition" . "∘") ("map" . "↦")))
...
(with-eval-after-load 'company
  ...
  ;; (define-key company-mode-map [tab] #'company-complete-selection)
...
(add-hook 'c++-mode-hook (lambda () (c-toggle-hungry-state)))
#+end_src
*** typescript
#+begin_src emacs-lisp
